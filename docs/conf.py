...
sys.path.insert(0, os.path.abspath('../src/cell_abm_pipeline'))
...
autodoc_mock_imports = ["numpy", "pandas", "tifffile", "imagecodecs", "matplotlib", "aicsimageio", "simulariumio", "scikit-image", "jupyter", "jupyterlab", "aicsshparam", "boto3", "trimesh", "Shapely", "quilt3", "hexalattice", "scipy", "vtk", "tqdm", "sklearn", "skimage", "click", "imageio", "networkx"]
